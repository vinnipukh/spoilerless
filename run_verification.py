...
def check_frontend_dep(line, pkg_name, min_ver=None):
...
def grep_symbol(line, symbol_name, search_dir=""):
    search_path = os.path.join(root, search_dir.replace('/', os.sep)) if search_dir else root
    regex = re.compile(r'\b' + re.escape(symbol_name) + r'\b')
    found_files = []
...
# Let's run all individual claim checks!
...
grep_symbol(59, "neo4j:2026.06.0-community") # in docker-compose.yml
check_backend_dep(60, "neo4j")
check_backend_dep(61, "google-auth")
check_backend_dep(63, "redis")
check_backend_dep(63, "fastapi-limiter")
...
check_file_path(182, "spoilerless/scripts/zombie_sweep.py")
...
check_file_path(220, "frontend/src/api/settings.ts")
...
check_file_path(229, "frontend/src/components/graph/PathFinder.tsx")
check_file_path(229, "frontend/src/components/graph/relationshipStyles.ts")
...
check_file_path(243, "frontend/src/providers/AuthContext.tsx")
...
# Section 4.1 Key Component references
...
# Section 4.3 Services & Repositories & Symbols
grep_symbol(315, "GraphService", "spoilerless/app/services")
grep_symbol(315, "fetch_graph", "spoilerless/app/services")
grep_symbol(316, "SeriesService", "spoilerless/app/services")
grep_symbol(317, "AuthService", "spoilerless/app/services")
grep_symbol(317, "ProductionGoogleVerifier", "spoilerless/app/services")
grep_symbol(318, "ProgressService", "spoilerless/app/services")
grep_symbol(318, "ProgressNotFoundError", "spoilerless/app/services")
grep_symbol(320, "ChatService", "spoilerless/app/services")
grep_symbol(321, "ChangeSetService", "spoilerless/app/services")
grep_symbol(322, "SettingsService", "spoilerless/app/services")
check_file_path(324, "spoilerless/app/services/rate_limit.py")

grep_symbol(330, "Neo4jDatabase", "spoilerless/app/graph")
grep_symbol(331, "UserRepository", "spoilerless/app/repository")
grep_symbol(332, "SessionRepository", "spoilerless/app/repository")
grep_symbol(332, "Neo4jSessionRepository", "spoilerless/app/repository")
grep_symbol(332, "InMemorySessionRepository", "spoilerless/app/repository")
grep_symbol(332, "sweep_expired", "spoilerless/app/repository")
grep_symbol(335, "ShareRepository", "spoilerless/app/repository")
grep_symbol(335, "Neo4jShareRepository", "spoilerless/app/repository")
grep_symbol(335, "InMemoryShareRepository", "spoilerless/app/repository")
grep_symbol(336, "UserContentRepository", "spoilerless/app/repository")
grep_symbol(337, "ChangeSetRepository", "spoilerless/app/repository")
grep_symbol(337, "ChatRepository", "spoilerless/app/repository")
grep_symbol(337, "SettingsRepository", "spoilerless/app/repository")
check_file_path(339, "spoilerless/scripts/zombie_sweep.py")

check_file_path(345, "spoilerless/app/graph/seed.py")
grep_symbol(385, "setup_database", "spoilerless/app/graph")
check_file_path(388, "spoilerless/app/graph/setup.py")
grep_symbol(388, "_check_visibility_schema", "spoilerless/app/graph")
...
grep_symbol(398, "require_node_type", "spoilerless/app/graph")
grep_symbol(398, "require_relationship_type", "spoilerless/app/graph")
grep_symbol(398, "require_claim_type", "spoilerless/app/graph")
grep_symbol(398, "user_safe_node_types", "spoilerless/app/graph")
grep_symbol(398, "user_safe_relationship_types", "spoilerless/app/graph")
check_file_path(399, "spoilerless/app/domain/graph.py")
check_file_path(401, "spoilerless/app/llm/provider.py")
grep_symbol(401, "LLMProvider", "spoilerless/app/llm")
grep_symbol(401, "OpenAICompatibleProvider", "spoilerless/app/llm")
grep_symbol(401, "GeminiProvider", "spoilerless/app/llm")
check_file_path(402, "spoilerless/app/retrieval/pipeline.py")
grep_symbol(402, "RetrievalPipeline", "spoilerless/app/retrieval")
check_file_path(403, "spoilerless/app/services/change_set.py")
check_file_path(404, "spoilerless/app/revisions/__init__.py")
grep_symbol(404, "log_revision", "spoilerless/app/revisions")
check_file_path(405, "spoilerless/app/repository/share.py")
check_file_path(406, "spoilerless/app/api/deps.py")
grep_symbol(406, "require_admin", "spoilerless/app/api")
grep_symbol(406, "RequireAdminDependency", "spoilerless/app/api")
check_file_path(407, "spoilerless/app/cache/redis_client.py")
grep_symbol(407, "get_redis", "spoilerless/app/cache")
check_file_path(408, "spoilerless/app/services/rate_limit.py")
grep_symbol(408, "RateLimiter", "spoilerless/app/services")
...
grep_symbol(526, "load_ontology", "spoilerless/app/graph")
grep_symbol(526, "Ontology", "spoilerless/app/graph")

check_file_path(545, "spoilerless/app/core/errors.py")
grep_symbol(545, "ERROR_CODES", "spoilerless/app/core")
grep_symbol(568, "install_database_error_handlers")
grep_symbol(568, "install_llm_error_handlers")
...
# Section 7.8 11 retrieval tools in tools.py
tools = [
...
grep_symbol(681, "assemble_context", "spoilerless/app/retrieval")
...
grep_symbol(709, "ExtractionBatchEnvelope", "spoilerless/app/domain")
grep_symbol(709, "ExtractionClaim", "spoilerless/app/domain")
...
grep_symbol(728, "UserPublic", "spoilerless/app/domain")
...
grep_symbol(737, "get_redis", "spoilerless/app/cache")
grep_symbol(744, "login_rate_limiter", "spoilerless/app/services")
grep_symbol(744, "chat_send_rate_limiter", "spoilerless/app/services")
grep_symbol(744, "content_write_rate_limiter", "spoilerless/app/services")
grep_symbol(748, "rate_limit_identifier", "spoilerless/app/services")
grep_symbol(748, "init_rate_limiter", "spoilerless/app/services")
grep_symbol(750, "DEFAULT_GRAPH_TTL_SECONDS", "spoilerless/app/cache")
grep_symbol(750, "invalidate_series", "spoilerless/app/cache")
