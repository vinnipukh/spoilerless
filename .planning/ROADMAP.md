...
- [x] 06-04-PLAN.md — Chat persistence (hide-not-delete regression) + REST completeness

**Wave 3** *(blocked on Wave 2)*

- [x] 06-05-PLAN.md — ChangeSet propose stage + canonical/candidate protection
- [x] 06-08-PLAN.md — Frontend chat/progress/ChangeSet data layer (types, API clients, hooks)

**Wave 4** *(blocked on Wave 3)*

- [x] 06-06-PLAN.md — ChangeSet confirm/apply, idempotency, revision audit
- [x] 06-09-PLAN.md — Frontend chat UI (DetailPanel mode toggle, ChatLauncher, message list, citations)

**Wave 5** *(blocked on Wave 4)*

- [x] 06-07-PLAN.md — ChangeSet revert
- [x] 06-10-PLAN.md — Frontend watch-progress backend wiring + graph-focus sync
