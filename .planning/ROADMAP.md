...
- ✅ **v1.5 Post-Hardening Remediation & Code Quality** — Phase 12 (shipped 2026-08-26)
...
- [x] 12-06-PLAN.md — Domain & Architectural Layering Cleanup (THERMO-P3-02, THERMO-P3-05, THERMO-P3-06) [Wave 2]
...
- [x] 12-08-PLAN.md — Frontend Architectural Decomposition & 1,000-Line Ceiling Elimination (THERMO-P0-02, THERMO-P0-03, THERMO-P0-04, THERMO-P2-05, THERMO-P2-07) [Wave 2]
- [x] 12-09-PLAN.md — Design System Tokens, Theme Harmonization & UI/UX Polish (THERMO-P2-06) [Wave 2]
- [x] 12-10-PLAN.md — Boundary & Persistence Refactoring (Extract require_boundary, replace inline candidate guards) [Wave 3]
- [x] 12-11-PLAN.md — Candidate Ingest Cypher & Revision Deserialization Optimization [Wave 3]
- [x] 12-12-PLAN.md — Graph Read Path Consolidation (GraphService.read_visible_graph facade) [Wave 3]
- [x] 12-13-PLAN.md — Async Event Loop & Rate Limiter Resilience Verification [Wave 3]
- [x] 12-14-PLAN.md — Cytoscape Element Adapter Unification (sceneElements module) [Wave 3]
- [x] 12-15-PLAN.md — Cache Invalidation Concentration behind GraphService facade [Wave 3]
...
---
*Last updated: 2026-08-26 — v1.5 Post-Hardening Remediation & Code Quality (Phase 12) SHIPPED. Phase 12 (15/15 plans) complete; frontend decomposed, response schemas aligned, boundary enforcement unified, single-query Cypher verified.*
