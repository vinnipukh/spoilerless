...
4. Evidence Chain uses a readable ELK/Dagre-style layered arrangement. Timeline is React/CSS, grouped by spoiler-safe plot thread and ordered by safe reveal/publication order. Fictional chronology may be display metadata only and cannot override reveal gating.
