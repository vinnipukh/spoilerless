...
| OpenAPI | Exact set of 18 `(method, path_template)` operations and exact set of 11 unique OpenAPI path templates; summaries; typed 200/201/204 and 404/409/422/503; required integer boundary; examples; health models. | `app.openapi()` from `main.py:35-54`; docs availability test `test_graph_api.py:73-87`. |
